...
def default_model_experiments(dataset_experiments):
    return {
        ...
        'Sequential Joint (SR First)': dataset_experiments.get_sequential_joint_sr_first(),
        'Sequential Joint (Seg First)': dataset_experiments.get_sequential_joint_seg_first()
    }